...
class InvoiceTest extends TestCase
{
    ...
    public function test_store_invoice_generates_and_streams_pdf(): void
    {
        ...
        Storage::assertExists('invoices/2026-06-03_john-doe_375000.pdf');
    }
    ...
    public function test_preview_streams_pdf_without_saving(): void
    {
        ...
        Storage::assertMissing('invoices/2026-06-03_john-doe_300000.pdf');
    }
    ...
    {
        Storage::fake('local');
        Storage::put('invoices/2026-06-03_john-doe_375000.pdf', 'fake pdf content');
        ...
        $response->assertInertia(fn ($page) => $page
            ...
            ->has('invoices', 1)
            ->where('invoices.0.filename', '2026-06-03_john-doe_375000.pdf')
    ...
    public function test_download_invoice(): void
    {
        ...
        $response = $this->authenticate()->get('/invoices/2026-06-03_john-doe_375000.pdf/download');

        $response->assertStatus(200);
        $response->assertDownload('2026-06-03_john-doe_375000.pdf');
    }
