...
<head>
    <meta charset="utf-8">
    <style>
        body { font-family: sans-serif; font-size: 13px; color: #1e1b17; margin: 0; padding: 40px; }

        /* Header */
        .header { display: table; width: 100%; margin-bottom: 30px; padding-bottom: 25px; border-bottom: 1px solid #d2c4b9; }
        ...
        .header-info h1 { margin: 0 0 5px 0; font-size: 24px; font-weight: 600; color: #735a3e; }
        .header-info p { margin: 2px 0; color: #4e453d; font-size: 12px; }

        /* Customer & Date Section */
        .meta-section { display: table; width: 100%; margin-bottom: 25px; }
        .bill-to { display: table-cell; width: 50%; vertical-align: top; }
        .bill-to-box { background: #faf2ec; padding: 15px; border-radius: 8px; border: 1px solid #d2c4b9; }
        .bill-to-label { font-size: 10px; font-weight: 600; color: #735a3e; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 5px; }
        .bill-to-name { font-size: 18px; font-weight: 600; margin: 5px 0 3px 0; }
        .bill-to-mobile { color: #4e453d; font-size: 13px; }
        .date-col { display: table-cell; width: 50%; vertical-align: middle; text-align: right; }
        .date-label { font-size: 13px; color: #4e453d; margin-right: 10px; }
        .date-value { font-size: 13px; font-weight: 600; }

        /* Items Table */
        .items { width: 100%; border-collapse: collapse; margin-bottom: 20px; }
        .items th { background: #735a3e; color: #ffffff; padding: 10px 15px; font-size: 12px; font-weight: 500; text-align: left; }
        ...
        .items td { padding: 12px 15px; border-bottom: 1px solid #d2c4b9; font-size: 13px; }
        .items td.center { text-align: center; color: #4e453d; }
        .items td.right { text-align: right; }
        .items td.amount { text-align: right; font-weight: 600; }
        .items tr:nth-child(even) { background: #faf2ec; }

        /* Total */
        .total-section { text-align: right; padding-top: 15px; margin-bottom: 30px; border-top: 2px solid #735a3e; }
        .total-label { font-size: 16px; font-weight: 600; }
        .total-value { font-size: 18px; font-weight: 700; color: #735a3e; margin-left: 15px; }

        /* Payment Footer */
        .payment { margin-top: 30px; padding-top: 25px; border-top: 1px solid #d2c4b9; }
        ...
        .qris-box { display: inline-block; border: 1px solid #d2c4b9; border-radius: 8px; padding: 5px; }
        .qris-box img { width: 160px; }
        .bank-box { background: #f4ece6; padding: 15px; border-radius: 8px; }
        .bank-label { font-size: 10px; font-weight: 600; color: #735a3e; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px; }
        .bank-row { display: table; width: 100%; padding: 5px 0; border-bottom: 1px solid #ffffff; }
        .bank-row:last-child { border-bottom: none; }
        .bank-row-label { display: table-cell; color: #4e453d; font-size: 12px; }
